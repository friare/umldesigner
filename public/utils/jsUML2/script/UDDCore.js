...
TextBox.prototype.showDialog = function() {
    ...
    a.focus();
    let editZone = document.getElementsByClassName('edit-zone')[0]
    f.style.top = (window.innerHeight - c.offsetHeight) / 2 + "px";
    f.style.left = ((window.innerWidth - parseInt(c.offsetWidth)) / 2) + (parseInt(editZone.offsetWidth)/2) + "px"
};
...
AttributeItem.prototype.showDialog = function() {
    ...
    a.style.left = ((window.innerWidth - b.offsetWidth) / 2) + (parseInt(editZone.offsetWidth)/2) + "px";
};
...
GuardItem.prototype.showDialog = function() {
    ...
    f.style.left = ((window.innerWidth - b.offsetWidth) / 2) + (parseInt(editZone.offsetWidth)/2) + "px";
...
Node.prototype.showStyleDialog = function(e) {
    ...
    let editZone = document.getElementsByClassName('edit-zone')[0]
    aa.style.top = (window.innerHeight - parseInt(aa.offsetHeight)) / 2 + "px";
    aa.style.left = ((window.innerWidth - parseInt(aa.offsetWidth)) / 2) + (parseInt(editZone.offsetWidth)/2) + "px"
};
Node.prototype.setTagValues = function(e) {
    if (!JSFun.isArray(e)) {
        return false
...
Relation.prototype.showStyleDialog = function(e) {
    ...
    L.style.left = ((window.innerWidth - parseInt(L.offsetWidth)) / 2) + (parseInt(editZone.offsetWidth)/2) + "px"
};
Relation.prototype.setMenu = function(a) {
    if (a instanceof Array) {
        this._menu = a
